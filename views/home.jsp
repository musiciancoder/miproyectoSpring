...
<!-- en la lista peliculas en el controlador, por cada objeto tipo pelicula , vamos a renderizar el codigo siguiente -->
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            ...
            <p><a class="btn btn-sm btn-primary" href="detail/${pelicula.id }/${fechaBusqueda}" role="button">Consulta Horarios &raquo;</a></p> <%-- href="detail/${pelicula.id } es para url dinamica --%>
          </div>
